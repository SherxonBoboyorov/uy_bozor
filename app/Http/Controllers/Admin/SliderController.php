...
class SliderController extends Controller
{
    ...
    public function store(CreateSlider $request)
    {
        ...
        return redirect()->route('slider.index')->with('message', 'Unable to create!!!');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('slider.index')->with('messsage', 'Unable to update');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('slider.index')->with('message', "Unable to delete");
    }
}
